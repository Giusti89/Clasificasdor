<x-guest-layout>
    <div class="contenido">
        ...
        <div class="titulo">
            <h1><b> OBSERVACIONES DE LA SOLICITUD DE MATERIALES Y/O CONTRATACION DE SERVICIOS </b></h1>
        </div>
        <div class="observacion">
            <p>{{ $reque->observaciones }}</p>
        </div>
                    ...
                    @foreach ($items as $item)
                        <tr>
                            ...
                            <td class="filas-tabla">
                                ...
                                <x-layouts.btnmodif rutaEnvio="editItem" dato="{{ $encryptedId }}" nombre="Editar">
                                </x-layouts.btnmodif>
                            </td>
