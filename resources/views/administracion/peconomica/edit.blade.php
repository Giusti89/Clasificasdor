<x-guest-layout>
    ...
    <div class="contenido">
        ...
        <form method="POST" action="{{ route('updateTeco', $teco->id) }}">
            @csrf
            @method('patch')

            <div class="mt-4">
                <x-input-label for="nombre" :value="__('Nombre de la partida económica')" />
                <x-text-input id="nombre" class="block mt-1 w-full" type="text" name="nombre" :value="old('nombre', $teco->nombre)"
            ...
            <div class="mt-4">
                ...
                <x-text-input id="codigo" class="block mt-1 w-full" type="number" name="codigo" :value="old('codigo', $teco->npartida)"
            ...
            <div class="mt-4">
                ...
                <x-text-input id="presupuesto" class="block mt-1 w-full" type="number" name="presupuesto" :value="old('presupuesto', $teco->presupuesto)"
                    autofocus autocomplete="presupuesto" readonly/>
            ...
            <div class="mt-4">
                ...
                <textarea name="descripcion" id="descripcion" cols="30" rows="10">{{ old('descripcion', $teco->descripcion) }}</textarea>
